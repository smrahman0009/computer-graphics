...
void ship_bell_effect();
void ship_horn_effect();
void carn_horn_effect();
void bus_moving_effect();
...
void bus_moving_effect(){
    sndPlaySound(TEXT("C:\\Users\\Musfiq\\OneDrive\\CG\\main\\test\\sound\\bus_moving.wav"),SND_ASYNC);
}
void carn_horn_effect(){

     sndPlaySound(TEXT("C:\\Users\\Musfiq\\OneDrive\\CG\\main\\test\\sound\\car_horn.wav"),SND_ASYNC);
}
void ship_bell_effect(){
    sndPlaySound(TEXT("C:\\Users\\Musfiq\\OneDrive\\CG\\main\\test\\sound\\ship_bell.wav"),SND_ASYNC);

}
void ship_horn_effect(){
    sndPlaySound(TEXT("C:\\Users\\Musfiq\\OneDrive\\CG\\main\\test\\sound\\ship_horn.wav"),SND_ASYNC);
}
